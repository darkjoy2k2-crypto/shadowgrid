...
class EmotionEngine:
    ...
    def process_perception_events(self, context: Optional[Dict[str, Any]] = None) -> None:
        ...
        for ev in new_events:
            ...
            elif event_token in ("JACK_REGISTERED_BY_CAMERA", "CAMERA_SPOTTED"):
                situation_key = "CAMERA_SPOTTED"
                is_critical = True
            elif event_token == "SENTINEL_ALARM_DISPATCHED":
                situation_key = "SENTINEL_DISPATCHED"
                is_critical = True
            elif event_token == "SENTINEL_EMPTIED_IOT":
                situation_key = "SENTINEL_EMPTIED_IOT"
                is_critical = True
